...
public class MeshDestroy : MonoBehaviour
{
    ...
    public bool childDestruction;
    public bool childCollision;
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            if(original.childDestruction)
            {
                var meshDestroy = GameObject.AddComponent<MeshDestroy>();
                meshDestroy.CutCascades = original.CutCascades;
                meshDestroy.ExplodeForce = original.ExplodeForce;
                meshDestroy.childDestruction = original.childDestruction;
                meshDestroy.childCollision = original.childCollision;
            }
